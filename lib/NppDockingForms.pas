...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, NppPlugin, NppForms;
...
begin
  ...
  begin
    ...
    r := Winapi.Windows.GetWindowLong(wincontrol.Handle, GWL_EXSTYLE);
    if (r and WS_EX_CONTROLPARENT = WS_EX_CONTROLPARENT) then
    begin
      Winapi.Windows.SetWindowLong(wincontrol.Handle, GWL_EXSTYLE, r and not WS_EX_CONTROLPARENT);
    end;
  end;
